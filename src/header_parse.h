 ...
 * @param addr The base address of the file.
 * @param offset The offset at which the NAL unit is located.
 */
 ...
 * @param addr The base address of the file.
 * @param offset The offset at which the SPS is located.
 */
 ...
 * @param addr The base address of the file.
 * @param offset The offset at which the PPS is located.
 */
 ...
 * @param addr The base address of the file.
 * @param offset The offset at which the slice header is located.
 */
 ...
 * @param addr The base address of the file.
 * @param offset The offset at which the MP4 box is located.
 */
